    ...
    public static void registry(MRA thisAgent, MRAInfo mraInfo) throws YPAException {
        ...
        try {
            ...
            if (inform == null) {
                ...
                System.out.println(inform.getSender().getLocalName() + ": Registration service successfully done for the agent " + request.getSender().getLocalName());
            }
        ...
        try {
            ...
            if (msg == null) {
                ...
                if (msg.getPerformative() == ACLMessage.FAILURE) {
                    ...
                    System.out.println(msg.getSender().getLocalName() + ": Search service successfully done for the agent " + thisAgent.getLocalName());   
                }
            }
        } catch (Codec.CodecException | OntologyException ex) {
